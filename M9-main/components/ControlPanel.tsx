...
import { SearchIcon, NavigationArrowIcon, RulerIcon, LayersIcon, BookmarkIcon, InspectIcon, SparklesIcon } from './Icons';
...
export const ControlPanel: React.FC<ControlPanelProps> = (props) => {
    const { onSearch, onRecenter, onToggleMeasurement, isMeasuring, isSearching, searchError, disableRecenter, onSetLayer, currentLayer, onToggleFavorites, mapLayers, isInspecting, onToggleInspector, onToggleAiAssistant } = props;
    ...
    return (
        <>
            <div className="absolute top-4 left-4 right-4 z-10 flex flex-col gap-2 md:right-auto md:w-96">
